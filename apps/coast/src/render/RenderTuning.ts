...
/** How far the bank under the deck's high side runs out, per metre it has to fall back to the ground.
 * 0 ends the deck in a sheer wall, which on a turn reads as a black wedge standing in the grass. */
export let BANK_BATTER = 1.8
...
export const RENDER_TUNE: TuneSection = {
  ...
  keys: [
    ...
    tune('BANK_BATTER', () => BANK_BATTER, (v) => (BANK_BATTER = v), [0, 6], 0.1, 'run of the bank per metre of drop'),
