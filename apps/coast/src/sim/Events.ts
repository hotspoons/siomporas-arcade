export type SimEventType = 'crash' | 'wreck' | 'bump' | 'offroad' | 'onroad' | 'checkpoint' | 'fork' | 'pass' | 'turbo' | 'turbo_earned' | 'gear' | 'timeout' | 'finish' | 'stage' | 'wipers' | 'lights' | 'launch' | 'land' | 'nearmiss'
