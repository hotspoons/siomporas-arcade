...
export const THEMES: Record<string, Theme> = {
  ...
  city: {
    ...
    density: 0.75,
    roadside: [
      { kind: 'block', weight: 5, minOffset: 2.0, maxOffset: 2.35 },
      { kind: 'block2', weight: 5, minOffset: 1.9, maxOffset: 2.25 },
      { kind: 'tower2', weight: 2, minOffset: 2.0, maxOffset: 2.4 },
      { kind: 'tower', weight: 1, minOffset: 2.1, maxOffset: 2.5 },
      { kind: 'lightpost', weight: 3, minOffset: 1.1, maxOffset: 1.18, collide: true },
      { kind: 'tree', weight: 1, minOffset: 1.2, maxOffset: 1.4 },
    ],
